...
namespace OpenEngine {
	...
	class OPENENGINE_API MouseScrolledEvent : public Event
	{
	public:
	...
	class OPENENGINE_API MouseButtonPressedEvent : public MouseButtonEvent
	{
	public:
	...
	class OPENENGINE_API MouseButtonReleasedEvent : public MouseButtonEvent
	{
	public:
